    ...
    <div class="content">
        <form id="form5" class="basic" runat="server">
            ...
            <div class="form_button">
                <asp:Button ID="btnSave" CssClass="btn_form" OnClick="btnSave_Click" OnClientClick="return validarTarea();" runat="server" Text="Guardar" />
            ...
            <asp:Button ID="btnListTasks" CssClass="btn_form" OnClick="btnListTasks_Click" runat="server" Text="Listar Tareas" />
